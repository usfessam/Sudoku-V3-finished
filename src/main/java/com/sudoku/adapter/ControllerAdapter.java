...
public class ControllerAdapter implements Controllable {
  ...
  public int[][] getGame(char level) throws NotFoundException {
    ...
    switch (level) {
      case 'e':
        game = controller.getGame(DifficultyEnum.EASY);
        break;
      case 'm':
        game = controller.getGame(DifficultyEnum.MEDIUM);
        break;
      case 'h':
        game = controller.getGame(DifficultyEnum.HARD);
        break;
      case 'c':
  ...
  public void markGameComplete(char level) throws IOException {
    ...
    switch (level) {
      ...
      case 'h':
        ...
        break;
      default:
        throw new IOException("Invalid difficulty level: " + level);
    }
